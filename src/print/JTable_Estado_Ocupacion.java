 ...
 * @author Usuario
 */
public class JTable_Estado_Ocupacion extends javax.swing.JFrame {
    ...
    public JTable_Estado_Ocupacion() {
        initComponents();
        tituloTabla.setText("R1Z_CONTROL_ESTADO_OCUPACION");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_Estado_Ocupacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTable_Estado_Ocupacion().setVisible(true);
            }
        });
    }
    ...
    private void consulta() {
        String sql = "select * from r1z_estado_ocupacion";
        ...
        try {
            ...
            while (rs.next()) {
                tipoClientes[0] = rs.getInt("EstOcuCod");
                tipoClientes[1] = rs.getString("EstOcuNom");
                tipoClientes[2] = rs.getString("EstOcuEstReg");
        ...
        switch (flagBoton) {
            case 1:
                ...
                if (((codigo.equals("")) || (nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "insert into r1z_estado_ocupacion (EstOcuCod, EstOcuNom, EstOcuEstReg) values('" + codigo + "','" + nombre + "','" + estado + "')";
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Nuevo Estado Ocupacion Registrado!");
                            limpiarFormulario();
            ...
            case 2:
                ...
                if (((nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "update r1z_estado_ocupacion set EstOcuNom='" + nombre + "' where EstOcuCod=" + codigo;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Tipo Proeyecto Actualizado!");
                            limpiarFormulario();
                            desactivarFormulario();
                            limpiarTabla();
                        } catch (Exception e) {
            ...
            case 3:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update r1z_estado_ocupacion set EstOcuEstReg='*' where EstOcuCod=" + codigo;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
                        JOptionPane.showMessageDialog(null, "Estado Ocupacion Eliminado!");
                        limpiarFormulario();
                        desactivarFormulario();
                        limpiarTabla();
                    } catch (Exception e) {
            ...
            case 4:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update r1z_estado_ocupacion set EstOcuEstReg='I' where EstOcuCod=" + codigo;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
                        JOptionPane.showMessageDialog(null, "Estado Ocupacion Inactivado!");
                        limpiarFormulario();
                        desactivarFormulario();
                        limpiarTabla();
                    } catch (Exception e) {
            ...
            case 5:
                ...
                if (estado.equals("*") || estado.equals("I")) {
                    if (carFlaAct == 1) {
                        try {
                            String sql = "update r1z_estado_ocupacion set EstOcuEstReg='A' where EstOcuCod=" + codigo;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Estado Ocupacion Reactivado!");
                            limpiarFormulario();
                            desactivarFormulario();
                            limpiarTabla();
                        } catch (Exception e) {
