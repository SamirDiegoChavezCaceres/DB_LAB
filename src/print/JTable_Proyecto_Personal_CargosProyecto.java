 ...
 * @author Usuario
 */
public class JTable_Proyecto_Personal_CargosProyecto extends javax.swing.JFrame {
    ...
    public JTable_Proyecto_Personal_CargosProyecto() {
        initComponents();
        tituloTabla.setText("P13001-CONTROL_PROYECTO-PERSONAL-CARGOSPROYECTO");
    ...
    private void initComponents() {
        ...
        txtCodeCli = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        txtCodePer = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        txtEstado = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        txtCodeTipPro = new javax.swing.JTextField();
        txtSecPro = new javax.swing.JTextField();
        jLabel6 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        txtCodeCarPro = new javax.swing.JTextField();
        ...
        txtCodeCli.setEditable(false);
        txtCodeCli.setName(""); // NOI18N

        jLabel3.setText("Codigo Personal");

        txtCodePer.setEditable(false);

        jLabel4.setText("Estado Registro");

        txtEstado.setEditable(false);

        jLabel5.setText("Codigo Tipo Proyecto");

        txtCodeTipPro.setEditable(false);
        txtCodeTipPro.setName(""); // NOI18N

        txtSecPro.setEditable(false);
        txtSecPro.setName(""); // NOI18N

        jLabel6.setText("Secuencia Proyecto");

        jLabel7.setText("Codigo Cargo Proyecto");

        txtCodeCarPro.setEditable(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(txtCodeTipPro, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtSecPro, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtCodePer, javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCodeCarPro, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtCodeCli))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtCodeCli, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(txtCodeTipPro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(txtSecPro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtCodePer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(txtCodeCarPro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Cliente", "Codigo Tipo Proyecto", "Secuencia Proeyecto", "Codigo Personal", "Codigo Cargo Proyecto", "Estado"
            }
        ));
    ...
    private final String NOMBRE_TABLA = "p1m_proyecto-personal-cargosproyecto";
    private final String NOMBRE_INSTACIA = "Proyecto-Personal-CargosProyecto";
    private final int CANTIDAD_DATOS = 6;
    
    private final String NOMBRE_DATO_1 = "p1m_proyecto_ProCliCod";
    private final String NOMBRE_DATO_2 = "p1m_proyecto_ProTipProCod";
    private final String NOMBRE_DATO_3 = "p1m_proyecto_ProSecPro";
    private final String NOMBRE_DATO_4 = "ProPerCarProPerCod";
    private final String NOMBRE_DATO_5 = "ProPerCarProCarProCod";
    private final String NOMBRE_DATO_6 = "ProPerCarProEstReg";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_Proyecto_Personal_CargosProyecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTable_Proyecto_Personal_CargosProyecto().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtCodeCarPro;
    private javax.swing.JTextField txtCodeCli;
    private javax.swing.JTextField txtCodePer;
    private javax.swing.JTextField txtCodeTipPro;
    private javax.swing.JTextField txtEstado;
    private javax.swing.JTextField txtSecPro;
    ...
    private void consulta() {
        ...
        try {
            ...
            while (rs.next()) { 
                ...
                tipoClientes[5] = rs.getString(NOMBRE_DATO_6);
    ...
    private void agregar() {
        ...
        txtCodeTipPro.setEditable(true);
        txtSecPro.setEditable(true);
        txtCodePer.setEditable(true);
        txtCodeCarPro.setEditable(true);
        
        txtCodeCli.setEditable(true);
        txtEstado.setText("A");
    ...
    private void actualizar() {
        String codigoCli = txtCodeCli.getText();
        String codigoTipPro = txtCodeTipPro.getText();
        String secuenciaPro = txtSecPro.getText();
        String codigoPer = txtCodePer.getText();
        String codigoCarPro = txtCodeCarPro.getText();
        String estado = txtEstado.getText();
        switch (flagBoton) {
            case 1:
                //AgregarBoton.setEnabled(false);
                if (((txtCodeCli.equals("")) || (txtCodeTipPro.equals("")) || (txtSecPro.equals("")) || (txtCodePer.equals("")) || (txtCodeCarPro.equals("")))) {
                    JOptionPane.showMessageDialog(null, "Falta Ingresar Datos!");
                } else {
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "insert into `"+NOMBRE_TABLA+"` ("+NOMBRE_DATO_1+", "+NOMBRE_DATO_2+", "+NOMBRE_DATO_3+", "+NOMBRE_DATO_4+", "+NOMBRE_DATO_5+", "+NOMBRE_DATO_6+")"
                                                             + " values('" + codigoCli + "','" + codigoTipPro + "','" + secuenciaPro + "','" + codigoPer + "','" + codigoCarPro + "','" + estado + "')";
            ...
            case 2:
                ...
                if (((secuenciaPro.equals("")))) {
                    JOptionPane.showMessageDialog(null, "Falta Ingresar Nombre!");
                } else {
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "update `"+NOMBRE_TABLA+"` set "+NOMBRE_DATO_3+"='" + secuenciaPro + "' where "+NOMBRE_DATO_1+"=" + codigoCli;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
            ...
            case 3:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update `"+NOMBRE_TABLA+"` set "+NOMBRE_DATO_6+"='*' where "+NOMBRE_DATO_1+"=" + codigoCli;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
            ...
            case 4:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update `"+NOMBRE_TABLA+"` set "+NOMBRE_DATO_6+"='I' where "+NOMBRE_DATO_1+"=" + codigoCli;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
            ...
            case 5:
                ...
                if (estado.equals("*") || estado.equals("I")) {
                    if (carFlaAct == 1) {
                        try {
                            String sql = "update `"+NOMBRE_TABLA+"` set "+NOMBRE_DATO_6+"='A' where "+NOMBRE_DATO_1+"=" + codigoCli;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
    ...
    private void limpiarFormulario() {
        String t = "";
        txtCodeCli.setText(t);
        txtCodeTipPro.setText(t);
        txtSecPro.setText(t);
        txtCodePer.setText(t);
        txtCodeCarPro.setText(t);
        txtEstado.setText(t);
    }
    ...
    private void eliminar() {
        ...
        if (fila == -1) {
            ...
            String codigoTipPro = (String) Tabla.getValueAt(fila, 1);
            String secPro = (String) Tabla.getValueAt(fila, 2);
            String codigoPer = (String) Tabla.getValueAt(fila, 3);
            String codigoCarPro = (String) Tabla.getValueAt(fila, 4);
            String estado = (String) Tabla.getValueAt(fila, 5);

            txtCodeCli.setText("" + idc);
            txtCodeCli.setEditable(false);
            txtCodeCli.setEnabled(false);
            
            txtCodeTipPro.setText(codigoTipPro);
            txtCodeTipPro.setEditable(false);
            txtCodeTipPro.setEnabled(false);
            
            txtSecPro.setText(secPro);
            txtSecPro.setEditable(false);
            txtSecPro.setEnabled(false);
            
            txtCodePer.setText(codigoPer);
            txtCodePer.setEditable(false);
            txtCodePer.setEnabled(false);

            txtCodeCarPro.setText(codigoCarPro);
            txtCodeCarPro.setEditable(false);
            txtCodeCarPro.setEnabled(false);
