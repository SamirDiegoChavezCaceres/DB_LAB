 ...
 * @author Usuario
 */
public class JTable_PersonalCargosProyecto extends javax.swing.JFrame {
    ...
    public JTable_PersonalCargosProyecto() {
        initComponents();
        tituloTabla.setText("P1M_PERSONAL_CARGOS_PROYECTO");
    ...
    private void initComponents() {
        ...
        estRegistro = new javax.swing.JTextField();
        ...
        jLabel2.setText("Personal Codigo");

        txtCode.setEditable(false);
        txtCode.setName(""); // NOI18N

        jLabel3.setText("Cargo Proyecto");

        txtNom.setEditable(false);

        jLabel4.setText("Estado Registro");

        estRegistro.setEditable(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(estRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtCode, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtNom, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(estRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private final String NOMBRE_TABLA = "p1m_personal_cargos_proyecto";
    private final String NOMBRE_INSTACIA = "Personal Cargos Proyecto";
    private final int CANTIDAD_DATOS = 3;
    
    private final String NOMBRE_DATO_1 = "PerCarProPerCod";
    private final String NOMBRE_DATO_2 = "PerCarProCarProCod";
    private final String NOMBRE_DATO_3 = "PerCarProEstReg";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_PersonalCargosProyecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTable_PersonalCargosProyecto().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField estRegistro;
    ...
    private void actualizar() {
        ...
        String estado = estRegistro.getText();
        switch (flagBoton) {
            case 1:
            ...
            case 2:
                ...
                if (((nombre.equals("")))) {
                    JOptionPane.showMessageDialog(null, "Falta Ingresar Codigo!");
                } else {
                    if ((carFlaAct == 1)) {
                        try {
    ...
    private void eliminar() {
        ...
        if (fila == -1) {
            ...
            estRegistro.setText(estado);
            estRegistro.setEditable(false);
            estRegistro.setEnabled(false);
            carFlaAct = 1;
