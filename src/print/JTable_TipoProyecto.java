 ...
 * @author Usuario
 */
public class JTable_TipoProyecto extends javax.swing.JFrame {
    ...
    public JTable_TipoProyecto() {
        initComponents();
        tituloTabla.setText("P1Z_CONTROL_TIPO_PROYECTO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_TipoProyecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTable_TipoProyecto().setVisible(true);
            }
        });
    }
    ...
    private void consulta() {
        String sql = "select * from p1z_tipo_proyecto";
        ...
        try {
            ...
            while (rs.next()) {
                tipoClientes[0] = rs.getInt("TipProCod");
                tipoClientes[1] = rs.getString("TipProNom");
                tipoClientes[2] = rs.getString("TipProEstReg");
        ...
        switch (flagBoton) {
            case 1:
                ...
                if (((codigo.equals("")) || (nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "insert into p1z_tipo_proyecto (TipProCod, TipProNom, TipProEstReg) values('" + codigo + "','" + nombre + "','" + estado + "')";
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Nuevo Tipo Proyecto Registrado!");
                            limpiarFormulario();
            ...
            case 2:
                ...
                if (((nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "update p1z_tipo_proyecto set TipProNom='" + nombre + "' where TipProCod=" + codigo;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
            ...
            case 3:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update p1z_tipo_proyecto set TipProEstReg='*' where TipProCod=" + codigo;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
                        JOptionPane.showMessageDialog(null, "Tipo Proyecto Eliminado!");
                        limpiarFormulario();
                        desactivarFormulario();
                        limpiarTabla();
                    } catch (Exception e) {
            ...
            case 4:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update p1z_tipo_proyecto set TipProEstReg='I' where TipProCod=" + codigo;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
                        JOptionPane.showMessageDialog(null, "Tipo Proyecto Inactivado!");
                        limpiarFormulario();
                        desactivarFormulario();
                        limpiarTabla();
                    } catch (Exception e) {
            ...
            case 5:
                ...
                if (estado.equals("*") || estado.equals("I")) {
                    if (carFlaAct == 1) {
                        try {
                            String sql = "update p1z_tipo_proyecto set TipProEstReg='A' where TipProCod=" + codigo;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Tipo Proyecto Reactivado!");
                            limpiarFormulario();
                            desactivarFormulario();
                            limpiarTabla();
                        } catch (Exception e) {
