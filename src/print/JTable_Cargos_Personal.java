 ...
 * @author Angel
 */
public class JTable_Cargos_Personal extends javax.swing.JFrame {
    ...
    public JTable_Cargos_Personal() {
        initComponents();
        tituloTabla.setText("GZZ_CONTROL_CARGOS_PERSONAL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_Cargos_Personal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTable_Cargos_Personal().setVisible(true);
            }
        });
    }
    ...
    private void consulta() {
        String sql = "select * from gzz_cargos_personal";

        try {
            conet = con1.getConnection();
            st = conet.createStatement();
            rs = st.executeQuery(sql);
            Object[] cargosPersonal = new Object[3];
            modelo = (DefaultTableModel) Tabla.getModel();
            while (rs.next()) {
                cargosPersonal[0] = rs.getInt("CarPerCod");
                cargosPersonal[1] = rs.getString("CarPerNom");
                cargosPersonal[2] = rs.getString("CarPerEstReg");
                modelo.addRow(cargosPersonal);
            }
        ...
        switch (flagBoton) {
            case 1:
                ...
                if (((codigo.equals("")) || (nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "insert into gzz_cargos_personal (CarPerCod, CarPerNom, CarPerEstReg) values('" + codigo + "','" + nombre + "','" + estado + "')";
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Nuevo Cargo Personal Registrado!");
                            limpiarFormulario();
            ...
            case 2:
                ...
                if (((nombre.equals("")))) {
                    ...
                    if ((carFlaAct == 1)) {
                        try {
                            String sql = "update gzz_cargos_personal set CarPerNom='" + nombre + "' where CarPerCod=" + codigo;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Cargo Personal Actualizado!");
                            limpiarFormulario();
                            desactivarFormulario();
                            limpiarTabla();
                        } catch (Exception e) {
            ...
            case 3:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update gzz_cargos_personal set CarPerEstReg='*' where CarPerCod=" + codigo;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
                        JOptionPane.showMessageDialog(null, "Cargo Personal Eliminado!");
                        limpiarFormulario();
                        desactivarFormulario();
                        limpiarTabla();
                    } catch (Exception e) {
            ...
            case 4:
                ...
                if (carFlaAct == 1) {
                    try {
                        String sql = "update gzz_cargos_personal set CarPerEstReg='I' where CarPerCod=" + codigo;
                        conet = con1.getConnection();
                        st = conet.createStatement();
                        st.executeUpdate(sql);
                        JOptionPane.showMessageDialog(null, "Cargo Personal Inactivado!");
                        limpiarFormulario();
                        desactivarFormulario();
                        limpiarTabla();
                    } catch (Exception e) {
            ...
            case 5:
                ...
                if (estado.equals("*") || estado.equals("I")) {
                    if (carFlaAct == 1) {
                        try {
                            String sql = "update gzz_cargos_personal set CarPerEstReg='A' where CarPerCod=" + codigo;
                            conet = con1.getConnection();
                            st = conet.createStatement();
                            st.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Cargo Personal Reactivado!");
                            limpiarFormulario();
                            desactivarFormulario();
                            limpiarTabla();
                        } catch (Exception e) {
